...
// Mock health score data - matches API response structure
...
export const mockMaintenanceHistory = (assetId: string): Maintenance[] => [
    {
        ...
        description:
            "Completed routine inspection of all structural components",
        priority: "medium",
        status: "completed",
        type: "preventive",
...
export const mockPreventiveMaintenancePlan = (
    assetId: string
): PreventiveMaintenancePlan => ({
    id: "plan-1",
    asset_id: assetId,
...
export const mockIncidents = (assetId: string): Incident[] => [
    {
        ...
        description:
            "Discovered a crack in the main support beam during inspection",
        severity: "high",
        status: "resolved",
        asset_id: assetId,
        location: {
