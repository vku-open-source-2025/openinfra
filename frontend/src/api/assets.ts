...
export const assetsApi = {
    ...
    uploadPhoto: async (id: string, file: File): Promise<Asset> => {
        ...
        const response = await httpClient.post<Asset>(
            `/assets/${id}/photos`,
            formData,
            {
                headers: {
    ...
    deleteAttachment: async (
        ...
        await httpClient.delete(
            `/assets/${id}/attachments/${encodeURIComponent(attachmentUrl)}`
        );
    },
    ...
    updateLifecycleStatus: async (
        ...
        const response = await httpClient.put<Asset>(
            `/assets/${id}/lifecycle-status`,
    ...
    getDocuments: async (id: string): Promise<AssetAttachment[]> => {
        ...
        const response = await httpClient.get<AssetAttachment[]>(
            `/assets/${id}/documents`
        );
        return response.data;
    },
    ...
    uploadDocument: async (
        ...
        const response = await httpClient.post<AssetAttachment>(
            `/assets/${id}/documents`,
            formData,
            {
                headers: {
