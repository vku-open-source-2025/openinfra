...
const Dashboard: React.FC = () => {
    ...
    const operationalRate = ((assetCount - activeAlerts) / assetCount * 100).toFixed(1);
                        ...
                        <h2 className="text-2xl font-bold text-slate-800">
                            {activeTab === 'dashboard' ? 'Overview' :
                                activeTab === 'map' ? 'Geospatial View' :
                                    activeTab === 'maintenance' ? 'Maintenance Schedule' : 'Analytics'}
                        </h2>
                                ...
                                <div className="bg-white rounded-xl shadow-sm border border-slate-200 h-full overflow-hidden flex flex-col">
                                    {selectedAsset ? (
                                        ...
                                        <div className="h-full flex flex-col items-center justify-center text-center p-8 text-slate-400">
                                            ...
                                            <p className="text-sm mt-2">Select an asset from the map or list to view details and maintenance history.</p>
                                        </div>
                                    )}
                                </div>
                            </div>
