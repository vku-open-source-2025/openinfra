...
const AboutUs: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-slate-500 max-w-2xl mx-auto">
            An open-source infrastructure management platform for smart cities
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-3xl">
          <div className="bg-sky-50/50 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              OpenInfra is a GIS-based system designed to help local governments efficiently 
              manage and monitor public infrastructure assets across Vietnam.
            </p>
            <p className="text-slate-600 leading-relaxed">
              We provide real-time IoT monitoring, interactive mapping, and maintenance 
              tracking — built with open standards for transparency and accessibility.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-6">
        <div className="container mx-auto max-w-3xl">
          <h2 className="text-2xl font-semibold text-slate-700 text-center mb-8">Features</h2>
      ...
      <section className="py-16 px-6 bg-slate-50/50">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-2xl font-semibold text-slate-700 text-center mb-3">Our Team</h2>
                  ...
                  {member.avatar ? (
                    <img
                      ...
                      onError={(e) => {
                        ...
                        (e.target as HTMLImageElement).parentElement!.innerHTML = `<span class="text-2xl font-medium text-sky-400">${member.name.split(' ').pop()?.charAt(0) || '?'}</span>`;
                      }}
                    />
                  ) : (
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-2xl font-semibold text-slate-700 text-center mb-3">Sponsors</h2>
          <p className="text-slate-500 text-center mb-10">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
            ...
            >
              ...
              <span className="mt-3 text-sm text-slate-400">VKU University</span>
            </a>
            ...
            >
              ...
              <span className="mt-3 text-sm text-slate-400">VKU IT Club</span>
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="py-6 px-6 border-t border-slate-100">
        <div className="container mx-auto max-w-4xl text-center">
          <p className="text-slate-400 text-xs">
            Licensed under{' '}
            <a href="https://www.apache.org/licenses/LICENSE-2.0" className="text-sky-500 hover:underline">
              Apache 2.0
            </a>
            {' '}·{' '}
            Data under{' '}
            <a href="https://opendatacommons.org/licenses/by/1-0/" className="text-sky-500 hover:underline">
              ODC-BY
            </a>
          </p>
        </div>
