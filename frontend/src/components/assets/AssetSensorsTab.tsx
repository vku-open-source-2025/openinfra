...
const getSampleRateSeconds = (sensor: {
  sample_rate?: unknown
  sampleRate?: unknown
}): number | null => {
  const rawSampleRate = sensor.sample_rate ?? sensor.sampleRate

  if (typeof rawSampleRate === "number" && Number.isFinite(rawSampleRate)) {
    return rawSampleRate
  }

  if (typeof rawSampleRate === "string") {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4">
        {sensors.map((sensor) => {
          const sampleRate = getSampleRateSeconds(
            sensor as { sample_rate?: unknown; sampleRate?: unknown }
          )
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="ml-2 font-medium">{sampleRate !== null ? `${sampleRate}s` : 'N/A'}</span>
                    </div>
                    <div>
