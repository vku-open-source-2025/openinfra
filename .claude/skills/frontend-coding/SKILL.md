...
description: Chuẩn coding frontend cho Command Center SOSConn trên React + TanStack Router + Leaflet. Dùng khi tạo trang admin, component map, xử lý realtime WebSocket/SSE, hoặc cần guideline UX cho vai trò chỉ huy.
