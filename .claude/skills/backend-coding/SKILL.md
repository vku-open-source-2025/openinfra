---
name: backend-coding
description: Hướng dẫn chuẩn coding backend cho SOSConn integration trên FastAPI + MongoDB + Celery. Dùng khi viết model, repository, service, router, Celery task, hoặc cần checklist test backend.
