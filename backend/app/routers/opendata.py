...
JSONLD_CONTEXT = {
    "@context": {
        ...
        "odcby": "https://opendatacommons.org/licenses/by/1-0/",
...
LICENSE_INFO = {
    ...
    "attribution": "Data provided by OpenInfra (https://openinfra.space). Licensed under ODC-BY."
}
...
@router.get("/assets",
    ...
    description="Get all infrastructure assets as a GeoJSON FeatureCollection in JSON-LD format. Licensed under ODC-BY."
)
...
async def license_info():
    """Return detailed ODC-BY license information"""
    return {
        **JSONLD_CONTEXT,
        "@type": "CreativeWork",
        "name": "ODC-BY License",
        **LICENSE_INFO,
        ...
        "attribution_example": 'Data source: OpenInfra (https://openinfra.space) - Licensed under ODC-BY'
    }
